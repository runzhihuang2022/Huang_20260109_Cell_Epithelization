...
$svgPath = Join-Path $figureDir 'FigureS7_revised_v01.svg'
$aiPath = Join-Path $figureDir 'FigureS7_revised_v01_editable.ai'
$pdfPath = Join-Path $figureDir 'FigureS7_revised_v01.pdf'
$auditPath = Join-Path $packageRoot 'QC\FigureS7_ai_audit.csv'
...
"DONE";
"@
$jsxPath = Join-Path $figureDir '_export_figureS7.jsx'

...
$svgPath = Join-Path $Root "outputs\vector\FigureS3_revised_v04_editable.svg"
$aiPath = Join-Path $Root "outputs\vector\FigureS3_revised_v04_editable.ai"
$previewPath = Join-Path $Root "QC\FigureS3_revised_v04_AI_preview.png"
